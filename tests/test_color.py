...
def test_color_finder(in_color, out_color, dmc_color):
    rgb = color.get_color(PATH + RGB_FILE)
...
def test_parse_raw_palette_file():
    ...
    color_data_correct = color.get_color(TEST_PATH + "color_data_correct.json")
    color_rgb_data_correct = color.get_color(TEST_PATH + "color_rgb_data_correct.json")
    color_encode_data_correct = color.get_color(
        TEST_PATH + "color_encoding_correct.json"
    )
